...
<html>
<head>
	<title>Rolex Watches| Chrono-Ticks</title>
...
<div id="navbar">
<ul>
		<li style="border: 1px solid #f9dfdc;" ><a class="active" href="rolex.php">Rolex</a></li>
...
<h3 style="color:#333; margin-left:450px;font-size:3em">Rolex Watches</h3>
<div class="row" id="clothing">
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='watch' AND brand='Rolex' ORDER BY id ASC");
if($results){ 
...
$products_item .= <<<EOT
	...
	<img src="res/rolex/{$obj->product_img_name}">
