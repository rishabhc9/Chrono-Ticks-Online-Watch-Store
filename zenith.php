...
<html>
<head>
	<title>Zenith Watches| Chrono-Ticks</title>
...
<ul>
		...
		<li style="border: 1px solid #f9dfdc;"><a  href="hublot.php">Hublot</a></li>
		<li style="border: 1px solid #f9dfdc;"><a class="active" href="zenith.php">Zenith</a></li>		
	</ul>
</div>
...
<h3 style="color:#333; margin-left:450px;font-size:3em">Zenith Watches</h3>
<div class="row" id="clothing">
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='watch' AND brand='Zenith' ORDER BY id ASC");
if($results){ 
...
$products_item .= <<<EOT
	...
	<img src="res/zenith/{$obj->product_img_name}">
